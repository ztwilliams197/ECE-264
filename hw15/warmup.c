...
uint8_t set_left_bits(uint8_t byte, uint8_t num_bits_to_set) {
	...
	return byte | create_string_of_1s_at_left(num_bits_to_set);  // TODO: replace this with a one-line implementation of this function.
}
...
uint8_t set_right_bits(uint8_t byte, uint8_t num_bits_to_set) {
	...
	return byte | create_string_of_1s_at_right(num_bits_to_set);  // TODO: replace this with a one-line implementation of this function.
}
...
uint8_t unset_left_bits(uint8_t byte, uint8_t num_bits_to_unset) {
	...
	return byte & create_string_of_0s_at_left(num_bits_to_unset);  // TODO: replace this with a one-line implementation of this function.
...
uint8_t unset_right_bits(uint8_t byte, uint8_t num_bits_to_unset) {
	...
	return byte & create_string_of_0s_at_right(num_bits_to_unset);  // TODO: replace this with a one-line implementation of this function.
}
...
uint8_t toggle_left_bits(uint8_t byte, uint8_t num_bits_to_toggle) {
	...
	return byte ^ create_string_of_1s_at_left(num_bits_to_toggle);  // TODO: replace this with a one-line implementation of this function.
}
...
uint8_t toggle_right_bits(uint8_t byte, uint8_t num_bits_to_toggle) {
	...
	return byte ^ create_string_of_1s_at_right(num_bits_to_toggle);  // TODO: replace this with a one-line implementation of this function.
}
